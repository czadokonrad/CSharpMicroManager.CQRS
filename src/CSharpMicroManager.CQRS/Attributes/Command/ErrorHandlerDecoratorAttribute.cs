...
/// <summary>
/// Defines attribute which target is <see cref="CommandHandlerDecorator{TCommand}"/> responsible for wrapping all chain into try catch block
...
/// </summary>
public sealed class ErrorHandlerDecoratorAttribute : CommandHandlerAttribute
{
}