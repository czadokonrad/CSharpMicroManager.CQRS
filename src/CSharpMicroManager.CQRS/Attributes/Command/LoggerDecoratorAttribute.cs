...
/// <summary>
/// Defines attribute which target is <see cref="CommandHandlerDecorator{TCommand}"/> responsible for logging
...
/// </summary>
public sealed class LoggerDecoratorAttribute : CommandHandlerAttribute
{
}